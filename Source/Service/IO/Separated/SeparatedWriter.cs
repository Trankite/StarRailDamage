...
{
    public class SeparatedWriter : FiledWriter
    {
        private bool _Separated = true;

        public SeparatedWriter(string filePath) : base(filePath) { }

        public SeparatedWriter(Stream stream) : base(stream) { }

        public SeparatedWriter(StreamWriter writer) : base(writer) { }
