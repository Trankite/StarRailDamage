...
{
    public class AvatarResponseServantLinkToAvatarSkill
    {
        ...
        [JsonPropertyName("desc_icon_map")]
        public AvatarResponseServantDescIconMap DescIconMap { get; set; } = new();

        [JsonPropertyName("linked_avatar")]
        public AvatarResponseServantLinkedAvatar LinkedAvatar { get; set; } = new();

        [JsonPropertyName("linked_skill_id")]
