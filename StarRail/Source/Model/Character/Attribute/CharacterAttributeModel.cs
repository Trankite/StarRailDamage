using Common.Source.Model.StarRail.Character.Attribute;
using UIDesign.Source.Factory.NotifyPropertyChanged;

namespace StarRail.Source.Model.Character.Attribute
{
    public class CharacterAttributeModel : NotifyPropertyChangedFactory, ICharacterAttributeModel
    {
